...
public class RelationMain {
	public static void main(String[] args) {
		 ...
		 * process(); System.out.println("----------ooo----------");
		 * context.getBean(UnidirectionalOneToManyEmbeddedController.class).
		 * process(); System.out.println("----------ooo----------");
		 * context.getBean(UnidirectionalOneToManyController.class).process();
		 * System.out.println("----------ooo----------");
		 * context.getBean(BidirectionalOneToOneEmbeddedController.class).
		 * process(); System.out.println("----------ooo----------");
		 * context.getBean(BidirectionalOneToOneJoinColumnController.class).
		 * process(); System.out.println("----------ooo----------");
		 * context.getBean(BidirectionalOneToOneMappedByController.class).
		 * process(); System.out.println("----------ooo----------");
		 * context.getBean(BidirectionalManyToOneJoinColumnController.class).
		 * process(); System.out.println("----------ooo----------");
		 * context.getBean(BidirectionalOneToManyMappedByController.class).
		 * process(); System.out.println("----------ooo----------");
